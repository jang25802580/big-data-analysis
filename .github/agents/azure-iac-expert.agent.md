...
- Call appropriate Azure MCP tools based on specific resource type for data plane metadata collection:
  - `#tool:com.microsoft/azure/storage` for Storage Accounts data plane metadata and configuration insights
  - `#tool:com.microsoft/azure/keyvault` for Key Vault data plane metadata and policy analysis
  - `#tool:com.microsoft/azure/aks` for AKS cluster data plane metadata and configuration details
  - `#tool:com.microsoft/azure/appservice` for App Service data plane metadata and application analysis
  - `#tool:com.microsoft/azure/cosmos` for Cosmos DB data plane metadata and database properties
  - `#tool:com.microsoft/azure/postgres` for PostgreSQL data plane metadata and configuration analysis
  - `#tool:com.microsoft/azure/mysql` for MySQL data plane metadata and database settings
  - `#tool:com.microsoft/azure/functionapp` for Function Apps data plane metadata
  - `#tool:com.microsoft/azure/redis` for Redis Cache data plane metadata
